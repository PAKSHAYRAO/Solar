...
function preload() {
    sunImg = loadImage("Sprites/sun.jpeg");
    mercuryImg = loadImage("Sprites/me.png/");
    venusImg = loadImage("Sprites/ve.png");
    earthImg = loadImage("Sprites/e.png");
    marsImg = loadImage("Sprites/m.png");
    jupeterImg = loadImage("Sprites/ju.png");
    saturnImg = loadImage("Sprites/s.jpg");
    uranusImg = loadImage("Sprites/n.jpg");
    neptuneImg = loadImage("Sprites/ep.png");
